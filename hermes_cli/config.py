...
DEFAULT_CONFIG = {
    ...
    "discord": {
        ...
        "auto_thread_free_response_channels": "",  # Free-response channel IDs where auto-threading is still allowed
        "auto_thread_title": False,    # Rename Discord threads to Hermes' generated session title
